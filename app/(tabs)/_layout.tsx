...
export default function TabLayout() {
  ...
  const getTabBarHeight = () => {
    ...
    // Add safe area inset to height to ensure content isn't squashed
    // This fixes the collision with system back button/navigation bar
    const safeAreaHeight = baseHeight + insets.bottom;

    // For smaller screens, reduce height slightly
    if (width < 375) {
      return safeAreaHeight - 10 + tabletOffset;
    }
    return safeAreaHeight + tabletOffset;
  };
